...
\figscale{../figures/coherenceI3720140907.pdf}{Top: signals on about 20 hours. Middle: the 11 selected frequencies. A dot means that the MSC on the 3 nearest sensors if over 0.8 for the time window. Bottom: the 11 curves of the MSCs as a function of the interdistances.}{}{0.45}
...
\figsstit{../figures/CRBI037.pdf}{0.4}
 \vspace{-1cm}
\figscale{../figures/CRBI37.pdf}{500, 1000, 5000 are the aperture multiplicative factor of the I37 template reported on the RHS of the figure. LOC factor is $\beta=0$ and $\beta=1e^{-8}$. }{}{0.4}
