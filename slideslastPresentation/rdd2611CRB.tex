...
\figscale{stationexample.pdf}{$45$ sensors pairs}{fig:station example}{0.45}
...
\figscale{../figures/coherence2nearestI3720140904LOW.pdf}{Signals on about 20 hours. For the 6 selected frequencies,  time slots where the MSC on the 3 nearest sensors is over 0.8 are considered. The 6 curves of the MSCs as a function of the interdistances.}{}{0.4}
\end{frame}
%=======================================================
\begin{frame}
\begin{itemize}
...
\figsstit{../figures/CRBI037.pdf}{0.35}
 \vspace{-1cm}
