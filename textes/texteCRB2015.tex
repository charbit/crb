...
\begin{table}
\begin{tabular}{cc}
\includegraphics[scale=0.8]{../figures/tempspectanalysisH1I3720140905.pdf}
&
\includegraphics[scale=0.8]{../figures/tempspectanalysisH1bisI3720140905.pdf}
\end{tabular}
\begin{center}
\parbox{14 cm}
{
    \caption{\protect\small\it  {Typical observations on I37 during about $20$ hours. The signals are filtered in the band $0.01$ Hz to $4$ Hz and in the band $0.1$ Hz to $4$ Hz. The plot im grey represents the time observations. The color image represents the spectral analysis. The analysis time window is $500$ seconds. A low frequency components appears on the left figures.}}
