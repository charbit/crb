...
\figscale{stationexample.pdf}{$45$ sensors pairs}{}{0.45}

In a station design the two following elements could be of interest:
\begin{itemize}
 \item
the aperture% which is the radius of the smallest circle containing the station,
 \item
...
\begin{itemize}
 \item
the uniformity of the inter-distances %which could be useful in the case of loss of coherence. 
 \item
the isotropy w.r.t. the DOA accuracy% is almost independent of the direction of arrival of a planar wave.
\end{itemize}
\end{itemize}
 \end{frame}
%=======================================================
...
We consider a plane wave "not fully spatially coherent" and we assume that the loss of coherence (LOC) is given by
\begin{eqnarray*}
 \log \MSC(f) \approx -\beta f^2 \times d^2
\end{eqnarray*}
where $d$ is the distance between 2 points of observation, $f$  the frequency 	and $\beta$ a LOC decay factor. 
\end{frame}
%=======================================================
%=======================================================
\section{CRB}
...
\figscale{../figures/coherence2nearestI3720140904LOW.pdf}{Top: signals on about 20 hours. Middle: the 11 selected frequencies. A dot means that the MSC on the 3 nearest sensors if over 0.8 for the time window. Bottom: the 11 curves of the MSCs as a function of the interdistances.}{}{0.43}
...
\figsstit{../figures/CRBI037.pdf}{0.4}
 \vspace{-1cm}
\figscale{../figures/CRBI37.pdf}{500, 1000, 5000 are the aperture multiplicative factor of the I37 template reported on the RHS of the figure. LOC factor is $\beta=0$ and $\beta=1.9e^{-4}$. Maximal frequency $0.18$ Hz. }{}{0.34}
